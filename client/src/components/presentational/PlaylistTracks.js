...
class PlaylistTracks extends Component {
    ...
    render() {
        const { accessToken, selectedTrack } = this.state;
        const { isLoading, getLyrics, playlistTracks, updateAudio } = this.props; 
        ...
        <div class="modal-footer">
            <button type="button" class="btn btn-danger" data-dismiss="modal">Close</button>
                ...
                <section className="row">
                    ...
                    <a href={playlistTracks.external_urls.spotify} target="_blank">
